...
This folder shows the expected layout. **Do not submit your work here** — create your own path under `submissions/<your-github-username>/promise-them-nothing-twice/` at the repository root.
...
├── solution/
│   ├── README.md           # setup + how to run service and harness (≤15 min)
│   └── ...                 # your service and harness code
├── sessions/
│   ├── 01-framing.md       # chronological AI session exports
│   ├── 02-...
│   └── ...
